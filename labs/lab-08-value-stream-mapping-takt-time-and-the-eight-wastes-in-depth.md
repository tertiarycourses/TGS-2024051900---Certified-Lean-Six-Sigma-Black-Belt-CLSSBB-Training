...
Build a value stream map of your capstone process and quantify waste (A2, A4).
...
A current-state VSM with a value-added ratio, takt time and a quantified waste log.

**Tools and techniques:** VSM icons, material & information flow, lead time ladder, takt time, VA/NVA ratio, eight wastes
