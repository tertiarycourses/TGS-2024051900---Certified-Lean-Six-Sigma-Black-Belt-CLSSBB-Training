...
Translate VOC into measurable CTQs and cascade a business Y down to controllable Xs (A1, A4).
...
A CTQ tree with targets and specification limits, plus a flowdown to controllable Xs.

**Tools and techniques:** CTQ tree, need-driver-requirement, operational definitions, specification limits, Y-to-X cascade
