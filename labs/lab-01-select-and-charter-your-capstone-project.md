...
Select a viable Black Belt project from a candidate portfolio and charter it (A1, A2).
...
A scored project selection matrix and a signed-off capstone project charter.

**Tools and techniques:** Portfolio screening, strategic alignment, COPQ estimate, project charter, sponsor agreement
