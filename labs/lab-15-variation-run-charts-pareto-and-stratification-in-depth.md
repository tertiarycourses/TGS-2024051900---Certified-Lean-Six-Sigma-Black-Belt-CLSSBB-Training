...
Separate common from special cause variation and stratify your capstone data (A3).
...
A run chart with pattern analysis, a Pareto chart and a stratified defect analysis.

**Tools and techniques:** Common vs special cause, run chart patterns, tampering, Pareto principle, stratification, boxplots
