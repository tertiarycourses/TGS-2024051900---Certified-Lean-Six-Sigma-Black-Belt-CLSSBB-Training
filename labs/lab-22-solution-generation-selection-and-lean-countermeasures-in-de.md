...
Generate and select improvements targeting your proven root causes (A5).
...
A scored solution selection matrix mapping each solution to a proven root cause.

**Tools and techniques:** Brainstorming, brainwriting, SCAMPER, benchmarking, 5S, poka-yoke, pull/JIT, Heijunka, Jidoka, standard work, selection matrix
